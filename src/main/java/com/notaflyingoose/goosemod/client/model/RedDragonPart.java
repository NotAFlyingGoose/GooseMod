...
public class RedDragonPart extends PartEntity<RedDragon> {
    public final RedDragon parentMob;
    public final String name;
    private final EntityDimensions size;

    public RedDragonPart(RedDragon redDragon, String name, float scaleX, float scaleY) {
        super(redDragon);
        this.size = EntityDimensions.scalable(scaleX, scaleY);
        this.refreshDimensions();
        this.parentMob = redDragon;
        this.name = name;
    }
