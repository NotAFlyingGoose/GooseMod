...
import com.notaflyingoose.goosemod.entities.ThrownGooseEgg;
...
public class GooseEggItem extends Item {
    public GooseEggItem(Item.Properties p_41126_) {
        super(p_41126_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level p_41128_, Player p_41129_, InteractionHand p_41130_) {
        ...
        if (!p_41128_.isClientSide) {
            ThrownGooseEgg thrownegg = new ThrownGooseEgg(p_41128_, p_41129_);
